...
const Landing: React.FC = () => {
   return (
      <div className="w-full bg-[#FAFAFA] text-[#111]">
         <SeoHead
            title="Harbor: Enterprise Data Infrastructure for Multimodal AI"
            ...
            canonical="https://harborml.com/"
            ogImage="https://harborml.com/harbor-ml-logo.webp"
            keywords="AI training data, multimodal datasets, video annotation, machine learning data, enterprise data infrastructure"
            jsonLd={[
               {
                  "@type": "Organization",
                  "@id": "https://harborml.com/#organization",
                  "name": "Harbor ML",
                  "url": "https://harborml.com",
                  "logo": {
                     "@type": "ImageObject",
                     "url": "https://harborml.com/harbor-ml-logo.webp",
                     "width": 512,
                     "height": 512
                  },
                  "sameAs": [
                     "https://twitter.com/harborai",
                     "https://linkedin.com/company/harborml"
                  ],
                  "description": "Enterprise data infrastructure for multimodal AI training"
               },
               {
                  "@type": "WebSite",
                  "@id": "https://harborml.com/#website",
                  "url": "https://harborml.com",
                  "name": "Harbor ML",
                  "publisher": { "@id": "https://harborml.com/#organization" },
                  "potentialAction": {
                     "@type": "SearchAction",
                     "target": "https://harborml.com/search?q={search_term_string}",
                     "query-input": "required name=search_term_string"
                  }
               },
               {
                  "@type": "WebPage",
                  "@id": "https://harborml.com/#webpage",
                  "url": "https://harborml.com",
                  "name": "Harbor: Enterprise Data Infrastructure for Multimodal AI",
                  "description": "Training-ready image, audio, and video datasets for AI",
                  "isPartOf": { "@id": "https://harborml.com/#website" },
                  "about": { "@id": "https://harborml.com/#organization" }
               }
            ]}
         />

         {/* SECTION 1: HERO */}
         <section className="relative w-full pt-32 pb-16 px-6 md:px-12 lg:px-16 max-w-[1280px] mx-auto min-h-[70vh] flex flex-col justify-center overflow-hidden rounded-[2rem] mt-4">
            ...
            <div className="max-w-3xl relative z-10">
               ...
               <div className="flex flex-col md:flex-row items-center justify-center md:justify-start gap-4">
                  <Link to="/auth/signup" className="btn-primary hover:scale-105 transition-transform w-full md:w-auto text-center px-8 py-3">
                     Request Dataset Access
                  </Link>
                  <Link to="/contact" className="text-[#111] font-medium text-sm hover:text-gray-600 transition-colors border-b border-gray-300 pb-0.5 hover:border-black w-full md:w-auto text-center md:text-left py-3 md:py-0">
                     Contact Sales
                  </Link>
               </div>
            </div>
         ...
         <section className="py-20 px-6 md:px-12 lg:px-16 max-w-[1280px] mx-auto">
                  ...
                  <div key={i} className="bg-white p-6 md:p-10 hover:bg-gray-50 transition-colors min-h-[400px] md:aspect-square md:min-h-0 flex flex-col justify-between group overflow-hidden relative">
                     ...
                     {block.image && (
                        <div className="absolute inset-x-0 bottom-0 top-[45%] md:top-[22%] overflow-hidden">
                           <img
                              src={block.image}
                              alt={`Harbor ML ${block.title} - Enterprise data infrastructure feature`}
                              width={800}
                              height={600}
                              loading="lazy"
                              decoding="async"
         ...
         <section className="py-24 px-6 md:px-12 lg:px-16 max-w-[1280px] mx-auto bg-[#111] text-white rounded-[3rem] mb-12 overflow-hidden relative">
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
               ...
               <div className="relative w-full aspect-video md:h-[400px] md:aspect-auto rounded-2xl overflow-hidden border border-white/10 bg-white/5">
                  <img
                     src="/multimodal-data-infrastructure-hero.webp"
                     alt="Harbor ML multimodal data infrastructure diagram showing real-time video and audio processing pipeline"
                     width={1200}
                     height={675}
                     loading="lazy"
                     decoding="async"
