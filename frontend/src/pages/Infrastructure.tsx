    ...
    <div className="w-full bg-white animate-in fade-in duration-700">
      ...
      <section className="relative w-full px-4 md:px-6 py-4 max-w-[1600px] mx-auto">
        <div className="relative w-full h-[70vh] md:h-[75vh] rounded-2xl overflow-hidden bg-[#0B0F19] group border border-white/5">
          ...
          <img
            src="https://images.unsplash.com/photo-1558494949-ef526b01201b?q=80&w=2600&auto=format&fit=crop"
            alt="Harbor ML server infrastructure and data center for enterprise AI training workloads"
            width={2600}
            height={1733}
            loading="eager"
            decoding="sync"
            fetchPriority="high"
            className="absolute inset-0 w-full h-full object-cover opacity-50 group-hover:scale-105 transition-transform duration-[3s] ease-out saturate-0 group-hover:saturate-100"
          />
