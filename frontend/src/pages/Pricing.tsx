...
const Pricing: React.FC = () => {
  const handleCheckout = async (priceId: string) => {
    try {
      // Use full URL if relative fails or for testing
      const response = await fetch('http://localhost:3001/api/billing/create-checkout-session', {
        method: 'POST',
  ...
  return (
    <div className="w-full bg-[#050505] text-white animate-in fade-in duration-700 min-h-screen font-sans selection:bg-indigo-500 selection:text-white">
      <SeoHead
        title="Harbor Pricing: Enterprise AI & Media Data Plans"
        ...
        canonical="https://harborml.com/pricing"
        ogImage="https://harborml.com/harbor-ml-logo.webp"
        keywords="AI pricing, enterprise data pricing, media data plans, video annotation pricing, dataset API pricing"
        jsonLd={[
          {
            "@type": "WebPage",
            "@id": "https://harborml.com/pricing#page",
            "name": "Harbor ML Pricing",
            "description": "Flexible pricing for enterprise AI and media data solutions"
          },
          {
            "@type": "FAQPage",
            "mainEntity": [
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "The free tier includes basic API access, limited dataset downloads, and community support."
                }
              },
              {
                "@type": "Question",
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Enterprise pricing is based on usage volume, custom integrations, and dedicated support requirements. Contact sales for a custom quote."
                }
              },
              {
                "@type": "Question",
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Yes, you can change your plan at any time. Changes take effect at the start of your next billing cycle."
                }
              }
            ]
          }
      ...
      <section className="relative w-full px-4 md:px-6 py-4 max-w-[1600px] mx-auto">
        <div className="relative w-full h-[65vh] md:h-[70vh] rounded-2xl overflow-hidden bg-[#0B0F19] group border border-white/5">
          ...
          <img
            ...
            alt="Harbor ML pricing plans background with abstract data visualization"
            width={2960}
            height={1973}
            loading="eager"
            decoding="sync"
            fetchPriority="high"
            className="absolute inset-0 w-full h-full object-cover opacity-60 group-hover:scale-105 transition-transform duration-[3s] ease-out saturate-0 group-hover:saturate-100"
          />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="flex flex-col bg-[#0A0A0A] rounded-[2rem] p-8 border border-white/10 hover:border-white/20 transition-all hover:bg-[#0F0F0F] group">
            ...
            <div className="mt-auto">
              <button
                onClick={() => handleCheckout('price_advertising_solutions')}
                className="w-full bg-white text-black py-4 rounded-full font-medium hover:bg-gray-200 transition-colors mb-3">
                Book Demo
              </button>
          ...
          <div className="flex flex-col bg-[#0A0A0A] rounded-[2rem] p-8 border border-indigo-500/30 ring-1 ring-indigo-500/20 hover:border-indigo-500/50 transition-all hover:bg-[#0F0F0F] relative overflow-hidden">
            ...
            <div className="mt-auto">
              <button
                onClick={() => handleCheckout('price_foundation_access')}
                className="w-full bg-indigo-600 text-white py-4 rounded-full font-medium hover:bg-indigo-500 transition-colors mb-3 shadow-lg shadow-indigo-900/20">
                Request Access
              </button>
              <p className="text-center text-[10px] text-gray-600">
          ...
          <div className="flex flex-col bg-[#0A0A0A] rounded-[2rem] p-8 border border-white/10 hover:border-white/20 transition-all hover:bg-[#0F0F0F]">
            ...
            <div className="mt-auto">
              <button
                ...
                className="w-full bg-transparent border border-white/20 text-white py-4 rounded-full font-medium hover:bg-white/10 transition-colors mb-3">
                Contact Sales
              </button>
              <p className="text-center text-[10px] text-gray-600">
