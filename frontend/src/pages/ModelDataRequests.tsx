            ...
            <div className="max-w-[1200px] mx-auto">
               ...
               <div className="max-w-4xl">
                  ...
                  <p className="text-xl md:text-2xl text-stone-800 max-w-2xl mb-10 font-medium leading-relaxed text-left">
                     ...
                     If you can record yourself building physical models, you can submit for review.
                  </p>
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                     ...
                     <p className="text-sm text-stone-600 font-bold tracking-wide">
                        Fixed payouts for qualified submissions. No upfront commitment.
                     </p>
                  </div>
               </div>
            </div>
            ...
            <div className="max-w-[1200px] mx-auto">
               ...
               <div className="relative aspect-video md:aspect-[2.35/1] bg-black rounded-xl overflow-hidden border-2 border-black group cursor-pointer shadow-lg">
                  ...
                  <img
                     ...
                     alt="Hands building physical models"
                  />
               ...
               <div className="space-y-24">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                     <div className="order-2 md:order-1">
                        ...
                        <p className="text-xl text-stone-800 font-medium border-l-4 border-[#4B9F98] pl-4">Upload according to the posted guidelines. No editing required.</p>
                     </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                     <div className="order-2 md:order-1">
                        ...
                        <p className="text-xl text-stone-800 font-medium border-l-4 border-[#1A1A1A] pl-4">Fixed rates. Defined caps. Paid out directly.</p>
                     </div>
                     <div className="order-1 md:order-2 aspect-[4/3] bg-stone-200 rounded-xl overflow-hidden border-2 border-black shadow-md relative">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
                  ...
                  <div>
                     <p className="text-lg text-stone-800 mb-8 leading-relaxed font-medium text-left">
                        Payouts are fixed per qualified video. Contributors tend to fall within a predictable range once they understand the guidelines. There are caps in place to keep the program sustainable.
                     </p>
               ...
               <div className="max-w-[800px]">
                  ...
                  <div>
                     <AccordionItem
                        ...
                        answer="No. There is no fee, subscription, or buy-in."
                     />
                     <AccordionItem
                        question="Do I need followers or an audience?"
                        answer="No. Videos are submitted directly, not posted publicly."
                     />
                     <AccordionItem
                        question="Do I have to talk or show my face?"
                        answer="No. Hands-only videos are accepted."
                     />
                     <AccordionItem
                     ...
                     <AccordionItem
                        ...
                        answer="There’s no money taken from you, no vague requirements, and no earnings promises."
                     />
                     <AccordionItem
