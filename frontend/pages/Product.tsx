        ...
        <div className="relative w-full h-[75vh] min-h-[600px] rounded-2xl overflow-hidden bg-black text-white flex items-center justify-center border border-white/5">
          ...
          <div className="relative z-10 max-w-[1200px] w-full mx-auto px-6 text-center mt-0">
            ...
            <div className="flex flex-row items-center justify-center gap-4 mt-8">
              <button className="px-6 py-3 rounded-full border border-white/30 text-white font-medium text-sm hover:bg-white/10 transition-colors bg-black/20 backdrop-blur-sm flex items-center gap-2">
      ...
      <section className="py-24 px-6 text-center bg-gray-50 border-t border-gray-200">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button className="px-8 py-3.5 bg-[#1A1A1A] text-white rounded-full font-medium text-lg hover:bg-black transition-colors w-full sm:w-auto shadow-xl shadow-black/5">
